...
def load_model_and_tokenizer(device):
    ...
    state_dict = torch.load("protein_model.pth", map_location='cpu')
...
def main():
    datasets = ['gfp_sequences']
    max_length = 5800
    base_dir = "../../Benchmarking-tpLMs/data/gfp/"
    output_dir = '../../Benchmarking-tpLMs/embeddings/gfp/proteindt'
    protein_dictionary = {}
    combined_data_list = []
